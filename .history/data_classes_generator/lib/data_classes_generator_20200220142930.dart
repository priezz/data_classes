...
class DataClassGenerator extends GeneratorForAnnotation<GenerateDataClass> {
  ...
  generateForAnnotatedElement(
    ...
    buffer.writeAll([
      ...
      '$name.fromMutable($name$modelClassSuffix mutable, {void Function($name$modelClassSuffix source) update,}) {',
      '_model = $name$modelClassSuffix()',
      fields
      ...
      '$name copy(void Function($name$modelClassSuffix source) update) {',
      'assert(update != null,',
  ...
  String _fieldGetter(
    ...
    return '@override\n'
        ...
        '${field.type ?? dynamic} get ${field.name} => '
        '_model.${field.name};';
  }
