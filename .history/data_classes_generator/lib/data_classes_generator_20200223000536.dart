...
class DataClassGenerator extends GeneratorForAnnotation<GenerateDataClass> {
  ...
  generateForAnnotatedElement(
    ...
    buffer.writeAll([
      '// ignore_for_file: argument_type_not_assignable, lines_longer_than_80_chars, implicit_dynamic_parameter, non_constant_identifier_names, prefer_asserts_with_message, prefer_constructors_over_static_methods, prefer_expression_function_bodies, sort_constructors_first, unnecessary_getters_setters',
      ...
      '$name.from($modelName source, [${name}Builder build]): _model = $modelName() {\n',
      for (final field in fields)
        '_model.${field.name} = source.${field.name};',
      'build?.call(_model);\n',
      for (final field in fields)
      ...
      fields
          .map(
            (field) =>
                ...
                'eq(_model.${field.name}, other.${field.name})',
          )
          .join(' &&\n'),
      ';\n}\n',
      '@override',
