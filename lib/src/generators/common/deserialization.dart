...
extension ElementX on Element {
  String? get customSerializer => getAnnotation(JsonMethods)
      ?.getField('toJson')
      ?.toFunctionValue()
      ?.displayName;

  String? get customDeserializer => getAnnotation(JsonMethods)
      ?.getField('fromJson')
      ?.toFunctionValue()
      ?.displayName;

  String? get jsonKey =>
      getAnnotation(JsonKey)?.getField('name')?.toStringValue();
}
